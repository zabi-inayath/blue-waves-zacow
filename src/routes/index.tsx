...
const partners = [
  ...
  { name: "Taj sky view", logo: "/partners/Taj sky view.png" },
  { name: "Ceebros", logo: "/partners/Ceebros.jpg" },
  { name: "SIS", logo: "/partners/SIS.png" },
  { name: "L&T", logo: "/partners/L&T.jpg" },
  { name: "Navin’s", logo: "/partners/Navin’s.png" },
  { name: "Embassy Groups", logo: "/partners/Embassy Groups.jpg" },
  { name: "DAC Developers", logo: "/partners/DAC Developers.jpg" },
  { name: "VGN", logo: "/partners/VGN.png" },
  { name: "Baashyam", logo: "/partners/Baashyam.png" },
  { name: "Ramaniyam", logo: "/partners/Ramaniyam.jpg" },
  { name: "Tulive GK Shetty", logo: "/partners/Tulive GK Shetty.jpg" },
  { name: "Tulive GK Shetty", logo: "/partners/Jain Housing.jpg" },
